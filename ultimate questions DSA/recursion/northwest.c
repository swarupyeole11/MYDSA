...
void lcmethod::getMinValsPos(int value,int temp_data[][MAX],int ans[][2],int p
os[][2]){
 int k=0;
...
void copy2DArray(int startRow,int startCol,int endRow,int endCol,int array[][M
AX],int start1Row,int start1Col,int ans[][MAX]){
...
void lcmethod::display(){
 ...
 cout<<"\nhere "<<no_of_rows<<"+"<<no_of_columns<<"-
1 ="<<no_of_allocation<<" no. of allocations";
