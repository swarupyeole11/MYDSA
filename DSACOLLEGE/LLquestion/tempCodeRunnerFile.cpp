...
void CSELastInsert(int RollNos, string Names,string Branchs, int Markss)  //FUNCTION TO INSERT THE ELEMENT IN LINKED LIST AT THE LAST
 { 
     struct node *t = new node;
     t->RollNo=RollNos;
     t->Branch=Branchs;
...
//2---------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
  ...
  cout<<endl;
  CSELastInsert(4003,"SSS","MECH",95);
